/*
  ...
  Modified by Keith Dart to work with MochiKit and use newer HTML5 APIs.
*/
...
sorttable = {
  ...
  makeSortable: function(table) {
    ...
    for (var i=0; i<headrow.length; i++) {
      if (!headrow[i].classList.contains("sorttable_nosort")) { // skip this col in nosort added
          ...
          MochiKit.Signal.connect(headrow[i],"onclick", function(e) {
          ...
          MochiKit.Iter.forEach(theadrow.childNodes, function(cell) {
