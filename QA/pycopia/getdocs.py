...
"""
Create HTML documents from source files. 

NOTE: this module is experimental and incomplete.

Most of the parser code is taken from the parser module example script.

Simple code to extract class & function docstrings from a module.

This code was an example in the library reference manual in the
