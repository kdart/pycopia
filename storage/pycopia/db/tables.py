...
test_jobs =  Table('test_jobs', metadata,
    Column(u'id', PGInteger(), primary_key=True, nullable=False),
            ...
            Column(u'parameters', PGText(length=None, convert_unicode=False, assert_unicode=None), primary_key=False, nullable=False),
            Column(u'isscheduled', PGBoolean(), primary_key=False, nullable=False),
