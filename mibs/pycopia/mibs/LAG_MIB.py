...
# imports 
from SNMPv2_SMI import MODULE_IDENTITY, OBJECT_TYPE, Counter32, TimeTicks, BITS
from SNMPv2_CONF import MODULE_COMPLIANCE, OBJECT_GROUP
from SNMPv2_TC import DisplayString, MacAddress, TEXTUAL_CONVENTION, TruthValue
from IF_MIB import InterfaceIndex

class LAG_MIB(ModuleObject):
	path = '/usr/share/mibs/site/LAG-MIB'
	conformance = 1
	name = 'LAG-MIB'
	language = 2
	description = 'The Link Aggregation module for managing IEEE 802.3ad.'
...
class dot3adAggPortDebugRxState(ColumnObject):
	...
	enumerations = [Enum(1, 'current'), Enum(2, 'expired'), Enum(3, 'defaulted'), Enum(4, 'initialize'), Enum(5, 'lacpDisabled'), Enum(6, 'portDisabled')]
...
class dot3adAggPortDebugMuxState(ColumnObject):
	...
	syntaxobject = pycopia.SMI.Basetypes.Enumeration
	enumerations = [Enum(1, 'detached'), Enum(2, 'waiting'), Enum(3, 'attached'), Enum(4, 'collecting'), Enum(5, 'distributing'), Enum(6, 'collecting-distributing')]
