...
attribForua_757021613484612100 = pycopia.XML.POM.XMLAttribute(u'forua', pycopia.XML.POM.Enumeration((u'true', u'false')), 12, None)
...
class Meta(pycopia.XML.POM.ElementNode):
	ATTRIBUTES = {
         ...
         u'forua': attribForua_757021613484612100, 
         u'class': attribClass_1166814720137472289, 
	...
	KWATTRIBUTES = {
         ...
         'forua': attribForua_757021613484612100, 
