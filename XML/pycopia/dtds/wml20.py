...
attribWml_onpick_992825271556567684 = pycopia.XML.POM.XMLAttribute(u'wml:onpick', 1, 12, None)


attribWml_mode_4359039453746438400 = pycopia.XML.POM.XMLAttribute(u'wml:mode', pycopia.XML.POM.Enumeration((u'wrap', u'nowrap')), 12, None)


attribWml_format_2293480787786123049 = pycopia.XML.POM.XMLAttribute(u'wml:format', 1, 12, None)


attribWml_onenterforward_1501467663464458816 = pycopia.XML.POM.XMLAttribute(u'wml:onenterforward', 1, 12, None)
...
attribWml_ivalue_1100901627139096836 = pycopia.XML.POM.XMLAttribute(u'wml:ivalue', 1, 12, None)


attribWml_align_4587766684737820516 = pycopia.XML.POM.XMLAttribute(u'wml:align', 1, 12, None)


attribWml_forua_1932157415766546409 = pycopia.XML.POM.XMLAttribute(u'wml:forua', pycopia.XML.POM.Enumeration((u'true', u'false')), 13, u'true')


attribClassid_1987276650902832004 = pycopia.XML.POM.XMLAttribute(u'classid', 1, 12, None)


attribWml_type_308700889724747776 = pycopia.XML.POM.XMLAttribute(u'wml:type', 1, 12, None)
...
attribWml_columns_807605773853832100 = pycopia.XML.POM.XMLAttribute(u'wml:columns', 1, 12, None)
...
attribWml_iname_34208077922239081 = pycopia.XML.POM.XMLAttribute(u'wml:iname', 7, 12, None)


attribWml_value_3076031795781385156 = pycopia.XML.POM.XMLAttribute(u'wml:value', 1, 12, None)


attribVspace_995461752639063616 = pycopia.XML.POM.XMLAttribute(u'vspace', 1, 13, u'0')


attribWml_ontimer_21468281242659889 = pycopia.XML.POM.XMLAttribute(u'wml:ontimer', 1, 12, None)
...
attribWml_name_1511294756971649521 = pycopia.XML.POM.XMLAttribute(u'wml:name', 1, 12, None)
...
attribVersion_567649140214003600 = pycopia.XML.POM.XMLAttribute(u'version', 1, 14, u'-//WAPFORUM//DTD WML 2.0//EN')


attribWml_use_xml_fragments_1990591000529665249 = pycopia.XML.POM.XMLAttribute(u'wml:use-xml-fragments', pycopia.XML.POM.Enumeration((u'true', u'false')), 13, u'true')
...
attribWml_localsrc_395119948300862929 = pycopia.XML.POM.XMLAttribute(u'wml:localsrc', 1, 12, None)
...
attribCache_control_974438736159123225 = pycopia.XML.POM.XMLAttribute(u'cache-control', pycopia.XML.POM.Enumeration((u'no-cache',)), 12, None)
...
attribWml_newcontext_1619352523690957584 = pycopia.XML.POM.XMLAttribute(u'wml:newcontext', pycopia.XML.POM.Enumeration((u'true', u'false')), 13, u'false')
...
attribWml_emptyok_1792779347309986816 = pycopia.XML.POM.XMLAttribute(u'wml:emptyok', pycopia.XML.POM.Enumeration((u'true', u'false')), 12, None)
...
attribConversion_440185518281237089 = pycopia.XML.POM.XMLAttribute(u'conversion', pycopia.XML.POM.Enumeration((u'escape', u'noesc', u'unesc')), 13, u'noesc')


attribWml_onenterbackward_2609979860146017681 = pycopia.XML.POM.XMLAttribute(u'wml:onenterbackward', 1, 12, None)
...
attribXmlns_wml_4061985865634619664 = pycopia.XML.POM.XMLAttribute(u'xmlns:wml', 1, 14, u'http://www.wapforum.org/2001/wml')
...
class P(pycopia.XML.POM.ElementNode):
	ATTRIBUTES = {
         ...
         u'class': attribClass_1433549425767851536, 
         u'xml:lang': attribXml_lang_1645670971257252241, 
         u'wml:mode': attribWml_mode_4359039453746438400, 
         u'id': attribId_4002951160133423716, 
         }
	CONTENTMODEL = pycopia.XML.POM.ContentModel((True,))
	KWATTRIBUTES = {
         ...
         'xmlns': attribXmlns_2523611023564185025, 
         'title': attribTitle_1178737426446382009, 
         'wml_mode': attribWml_mode_4359039453746438400, 
         'xml_lang': attribXml_lang_1645670971257252241, 
...
class Img(pycopia.XML.POM.ElementNode):
	ATTRIBUTES = {
         ...
         u'wml:localsrc': attribWml_localsrc_395119948300862929, 
         u'class': attribClass_1433549425767851536, 
         ...
         u'id': attribId_4002951160133423716, 
         u'wml:type': attribWml_type_308700889724747776, 
         }
	CONTENTMODEL = pycopia.XML.POM.ContentModel(None)
	KWATTRIBUTES = {
         ...
         'xmlns': attribXmlns_2523611023564185025, 
         'title': attribTitle_1178737426446382009, 
         'wml_type': attribWml_type_308700889724747776, 
         'align': attribAlign_1715347099837610404, 
         'xml_lang': attribXml_lang_1645670971257252241, 
         'longdesc': attribLongdesc_35967826104941025, 
         'class_': attribClass_1433549425767851536, 
         'wml_localsrc': attribWml_localsrc_395119948300862929, 
...
class Table(pycopia.XML.POM.ElementNode):
	ATTRIBUTES = {
         ...
         u'xmlns': attribXmlns_2523611023564185025, 
         u'title': attribTitle_1178737426446382009, 
         u'wml:align': attribWml_align_4587766684737820516, 
         u'class': attribClass_1433549425767851536, 
         u'xml:lang': attribXml_lang_1645670971257252241, 
         u'wml:columns': attribWml_columns_807605773853832100, 
	...
	KWATTRIBUTES = {
         ...
         'xmlns': attribXmlns_2523611023564185025, 
         'title': attribTitle_1178737426446382009, 
         'wml_columns': attribWml_columns_807605773853832100, 
         'xml_lang': attribXml_lang_1645670971257252241, 
         'summary': attribSummary_965465820488927209, 
         'class_': attribClass_1433549425767851536, 
         'wml_align': attribWml_align_4587766684737820516, 
         'id': attribId_4002951160133423716, 
         }
	_name = u'table'
...
class Input(pycopia.XML.POM.ElementNode):
	ATTRIBUTES = {
         ...
         u'name': attribName_1485147577566348721, 
         u'title': attribTitle_1178737426446382009, 
         u'wml:emptyok': attribWml_emptyok_1792779347309986816, 
         u'accesskey': attribAccesskey_1489765571156059024, 
         u'value': attribValue_227024667205755136, 
         u'class': attribClass_1433549425767851536, 
         u'wml:format': attribWml_format_2293480787786123049, 
         u'xml:lang': attribXml_lang_1645670971257252241, 
         u'maxlength': attribMaxlength_3065314439821131481, 
         u'wml:name': attribWml_name_1511294756971649521, 
         u'tabindex': attribTabindex_1133897031401996169, 
	...
	KWATTRIBUTES = {
         ...
         'name': attribName_1485147577566348721, 
         'title': attribTitle_1178737426446382009, 
         'wml_format': attribWml_format_2293480787786123049, 
         'accesskey': attribAccesskey_1489765571156059024, 
         'wml_emptyok': attribWml_emptyok_1792779347309986816, 
         'xml_lang': attribXml_lang_1645670971257252241, 
         'value': attribValue_227024667205755136, 
         'class_': attribClass_1433549425767851536, 
         ...
         'id': attribId_4002951160133423716, 
         'wml_name': attribWml_name_1511294756971649521, 
...
class Select(pycopia.XML.POM.ElementNode):
	ATTRIBUTES = {
         u'wml:ivalue': attribWml_ivalue_1100901627139096836, 
         u'style': attribStyle_733285237156411536, 
         u'xmlns': attribXmlns_2523611023564185025, 
         u'multiple': attribMultiple_1058026172358336064, 
         u'name': attribName_1485147577566348721, 
         u'title': attribTitle_1178737426446382009, 
         u'wml:iname': attribWml_iname_34208077922239081, 
         u'class': attribClass_1433549425767851536, 
         u'wml:value': attribWml_value_3076031795781385156, 
         u'xml:lang': attribXml_lang_1645670971257252241, 
         u'wml:name': attribWml_name_1511294756971649521, 
         u'tabindex': attribTabindex_1133897031401996169, 
         u'id': attribId_4002951160133423716, 
	...
	CONTENTMODEL = pycopia.XML.POM.ContentModel((True,))
	KWATTRIBUTES = {
         'wml_ivalue': attribWml_ivalue_1100901627139096836, 
         'style': attribStyle_733285237156411536, 
         'xmlns': attribXmlns_2523611023564185025, 
         'multiple': attribMultiple_1058026172358336064, 
         'name': attribName_1485147577566348721, 
         'title': attribTitle_1178737426446382009, 
         'wml_iname': attribWml_iname_34208077922239081, 
         'xml_lang': attribXml_lang_1645670971257252241, 
         'wml_value': attribWml_value_3076031795781385156, 
         'class_': attribClass_1433549425767851536, 
         'tabindex': attribTabindex_1133897031401996169, 
         'id': attribId_4002951160133423716, 
         'wml_name': attribWml_name_1511294756971649521, 
...
class Option(pycopia.XML.POM.ElementNode):
	ATTRIBUTES = {
         u'wml:onpick': attribWml_onpick_992825271556567684, 
         u'style': attribStyle_733285237156411536, 
         u'xmlns': attribXmlns_2523611023564185025, 
         u'title': attribTitle_1178737426446382009, 
	...
	KWATTRIBUTES = {
         'style': attribStyle_733285237156411536, 
         'xmlns': attribXmlns_2523611023564185025, 
         'wml_onpick': attribWml_onpick_992825271556567684, 
         'title': attribTitle_1178737426446382009, 
...
class Meta(pycopia.XML.POM.ElementNode):
	ATTRIBUTES = {
         ...
         u'xml:lang': attribXml_lang_1645670971257252241, 
         u'wml:forua': attribWml_forua_1932157415766546409, 
	...
	KWATTRIBUTES = {
         ...
         'wml_forua': attribWml_forua_1932157415766546409, 
...
class Body(pycopia.XML.POM.ElementNode):
	ATTRIBUTES = {
         ...
         u'xmlns': attribXmlns_2523611023564185025, 
         u'title': attribTitle_1178737426446382009, 
         u'wml:newcontext': attribWml_newcontext_1619352523690957584, 
         u'class': attribClass_1433549425767851536, 
         u'xml:lang': attribXml_lang_1645670971257252241, 
         u'wml:onenterbackward': attribWml_onenterbackward_2609979860146017681, 
         u'wml:onenterforward': attribWml_onenterforward_1501467663464458816, 
         u'wml:ontimer': attribWml_ontimer_21468281242659889, 
         u'id': attribId_4002951160133423716, 
         }
	CONTENTMODEL = pycopia.XML.POM.ContentModel((True,))
	KWATTRIBUTES = {
         'style': attribStyle_733285237156411536, 
         'xmlns': attribXmlns_2523611023564185025, 
         'wml_onenterbackward': attribWml_onenterbackward_2609979860146017681, 
         'title': attribTitle_1178737426446382009, 
         'wml_ontimer': attribWml_ontimer_21468281242659889, 
         'xml_lang': attribXml_lang_1645670971257252241, 
         'class_': attribClass_1433549425767851536, 
         'wml_onenterforward': attribWml_onenterforward_1501467663464458816, 
         'wml_newcontext': attribWml_newcontext_1619352523690957584, 
         'id': attribId_4002951160133423716, 
         }
	_name = u'body'
...
class Html(pycopia.XML.POM.ElementNode):
	ATTRIBUTES = {
         u'xmlns': attribXmlns_2523611023564185025, 
         u'xmlns:wml': attribXmlns_wml_4061985865634619664, 
         u'xml:lang': attribXml_lang_1645670971257252241, 
         u'wml:use-xml-fragments': attribWml_use_xml_fragments_1990591000529665249, 
         u'version': attribVersion_567649140214003600, 
         u'wml:onenterbackward': attribWml_onenterbackward_2609979860146017681, 
         u'wml:onenterforward': attribWml_onenterforward_1501467663464458816, 
         u'wml:ontimer': attribWml_ontimer_21468281242659889, 
         }
	...
	KWATTRIBUTES = {
         ...
         'wml_onenterbackward': attribWml_onenterbackward_2609979860146017681, 
         'wml_ontimer': attribWml_ontimer_21468281242659889, 
         'xmlns_wml': attribXmlns_wml_4061985865634619664, 
         'version': attribVersion_567649140214003600, 
         'wml_use_xml_fragments': attribWml_use_xml_fragments_1990591000529665249, 
         'wml_onenterforward': attribWml_onenterforward_1501467663464458816, 
         }
	_name = u'html'
...
class Wml_go(pycopia.XML.POM.ElementNode):
	ATTRIBUTES = {
         ...
         u'href': attribHref_1415841210624387600, 
         u'cache-control': attribCache_control_974438736159123225, 
	...
	KWATTRIBUTES = {
         'style': attribStyle_733285237156411536, 
         'xmlns': attribXmlns_2523611023564185025, 
         'cache_control': attribCache_control_974438736159123225, 
         'title': attribTitle_1178737426446382009, 
...
class Wml_getvar(pycopia.XML.POM.ElementNode):
	ATTRIBUTES = {
         ...
         u'name': attribName_3839651748354608356, 
         u'title': attribTitle_1178737426446382009, 
         u'conversion': attribConversion_440185518281237089, 
         u'class': attribClass_1433549425767851536, 
         u'id': attribId_4002951160133423716, 
         }
	CONTENTMODEL = pycopia.XML.POM.ContentModel(None)
	KWATTRIBUTES = {
         ...
         'name': attribName_3839651748354608356, 
         'title': attribTitle_1178737426446382009, 
         'conversion': attribConversion_440185518281237089, 
         'class_': attribClass_1433549425767851536, 
         'id': attribId_4002951160133423716, 
         }
	_name = u'wml:getvar'
