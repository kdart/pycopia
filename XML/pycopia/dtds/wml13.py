...
attribEmptyok_1081475332552563844 = pycopia.XML.POM.XMLAttribute(u'emptyok', pycopia.XML.POM.Enumeration((u'true', u'false')), 12, None)
...
class Input(pycopia.XML.POM.ElementNode):
	ATTRIBUTES = {
         ...
         u'class': attribClass_1166814720137472289, 
         u'xml:lang': attribXml_lang_1645670971257252241, 
         u'emptyok': attribEmptyok_1081475332552563844, 
	...
	KWATTRIBUTES = {
         ...
         'value': attribValue_227024667205755136, 
         'class_': attribClass_1166814720137472289, 
         'emptyok': attribEmptyok_1081475332552563844, 
